  ...
  return (
    <div ref={rootRef} className={cn('relative', className)}>
      ...
      {open ? (
        <div
          role="listbox"
          className="absolute z-40 mt-1 w-full rounded-md border border-slate-200 bg-white p-1 shadow-lg dark:border-slate-700 dark:bg-slate-900"
        >
          <div className="select-scrollbar max-h-60 overflow-y-auto overflow-x-hidden">
            {options.map((option) => {
